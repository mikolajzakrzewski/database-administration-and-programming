...
UPDATE interns
SET birth_date = (SELECT e.hire_date
                  FROM employees AS e
                  WHERE first_name = 'Mike'
                    AND last_name = 'Thompson') - INTERVAL '20 years'
...
-- Postgres
SELECT CAST(CURRENT_TIMESTAMP AS DATE) AS date, TO_CHAR(CURRENT_TIMESTAMP, 'hh24:mi:ss') AS time
